# PATH — ensure core system paths are always present
export PATH="$HOME/.local/bin:/opt/homebrew/bin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin"
[ -n "$PATH" ] && export PATH="$HOME/.local/bin:/opt/homebrew/bin:$PATH"
...
[ -s "/opt/homebrew/opt/nvm/libexec/nvm.sh" ] && \
...
# Prompt — force emacs mode to prevent starship vi-mode recursion
bindkey -e
...
# --- Color Scheme (generated from shared/colors.conf) ---
